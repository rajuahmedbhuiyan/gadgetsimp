...
function Sidebar({
  ...
  return (
    <div
      // `lg`, not shadcn's `md`: below 1024px this app is a phone, and the
      // `isMobile` branch above has already rendered the sheet. The two have to
      // switch at the same width or a tablet gets both.
